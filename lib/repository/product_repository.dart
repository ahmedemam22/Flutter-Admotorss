...
import 'package:flutteradmotors/viewobject/favourite_product.dart';
import 'package:flutteradmotors/viewobject/holder/mark_sold_out_item_parameter_holder.dart';
import 'package:flutteradmotors/viewobject/follower_item.dart';
import 'package:flutteradmotors/viewobject/related_product.dart';
...
import 'package:flutteradmotors/viewobject/product_map.dart';
...
class ProductRepository extends PsRepository {
  ...
  Future<dynamic> getProductList(
    ...
    if (isConnectedToInternet) {
      final PsResource<List<Product>> _resource =
          await _psApiService.getProductList(holder.toMap(), loginUserId, limit, offset);
  ...
  Future<dynamic> getNextPageProductList(
   ...
   Future<dynamic> getItemDetailFromServerDirectly(
      StreamController<PsResource<Product>> itemDetailStream,
      String itemId,
      String loginUserId,
      bool isConnectedToInternet,
  ...
  Future<dynamic> getRelatedProductList(
    ...
    if (isConnectedToInternet) {
      final PsResource<List<Product>> _resource = await _psApiService
          .getRelatedProductList(productId, categoryId, loginUserId, limit, offset);
